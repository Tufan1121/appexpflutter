...
RouteBase get $pedidoSesionRoute => GoRouteData.$route(
      path: '/pedido_sesion',
      factory: $PedidoSesionRoute._fromState,
    );

mixin $PedidoSesionRoute on GoRouteData {
  ...
  PedidoSesionRoute get _self => this as PedidoSesionRoute;
  ...
  String get location => GoRouteData.$location(
        ...
        queryParams: {
          'id-cliente': _self.idCliente.toString(),
          'nombre-cliente': _self.nombreCliente,
          'estado': _self.estado.toString(),
          'id-sesion': _self.idSesion.toString(),
          'telefono-cliente': _self.telefonoCliente,
        },
      );
...
RouteBase get $reportesScreenRoute => GoRouteData.$route(
      path: '/reportes',
      factory: $ReportesScreenRoute._fromState,
    );

mixin $ReportesScreenRoute on GoRouteData {
...
RouteBase get $authReportesScreenRoute => GoRouteData.$route(
      path: '/auth_reportes',
      factory: $AuthReportesScreenRoute._fromState,
    );

mixin $AuthReportesScreenRoute on GoRouteData {
