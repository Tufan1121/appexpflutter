            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Expanded(
                      child: _PriceFooter(variante: active),
                    ),
          ...
          child: Container(
            ...
            child: firstFoto == null
                ...
                : FadeInImage.assetNetwork(
                    ...
                    image:
                        'https://tapetestufan.mx:446/imagen/_web/${Uri.encodeFull(firstFoto)}',
                    fit: BoxFit.cover,
...
class _PriceFooter extends StatelessWidget {
  ...
  const _PriceFooter({required this.variante});
  ...
  Widget build(BuildContext context) {
    ...
    final precios = <({String label, int precio})>[
      ...
      (label: 'Expo', precio: variante.precio2),
      (label: 'Mayoreo', precio: variante.precio3),
    ];
