    ...
    return Scaffold(
      ...
      body: PhotoViewGallery.builder(
        ...
        builder: (_, i) => PhotoViewGalleryPageOptions(
          ...
          heroAttributes:
              PhotoViewHeroAttributes(tag: 'pd-${widget.fotos[i]}'),
        ),
      ),
    );
  }
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        Utils.formatPrice(variantes[i].precio1.toDouble()),
                        textAlign: TextAlign.end,
                        style: const TextStyle(
                          fontSize: 13,
  ...
  Widget build(BuildContext context) {
    ...
    if (items.isEmpty) {
      return Container(
        ...
        child: const Text('Sin inventario',
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    items[i].existencia.toStringAsFixed(
                        items[i].existencia % 1 == 0 ? 0 : 2),
                    style: TextStyle(
                      fontSize: 13,
                      fontWeight: FontWeight.bold,
