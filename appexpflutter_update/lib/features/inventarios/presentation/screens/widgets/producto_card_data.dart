...
///
/// Agrupación inspirada en el web (`F:\python\galeria\busquedaglobal.html`
/// líneas 1746-1776), que agrupa por `diseno + pathima1`. Aquí añado
/// `descripcio` al key para evitar colisiones entre diseños con el mismo
/// color y foto reusada.
class ProductoCardData {
  ...
  /// Agrupa una lista de `ProductoExpoEntity` (Inventario Tienda / Búsqueda
  /// Global) en cards por diseño. Mismo `(descripcio, diseno, pathima1)` ⇒
  /// misma card; cada `medidas` distinto se vuelve una `Variante`.
  ...
  static ProductoCardData _buildFromExpoGroup(List<ProductoExpoEntity> group) {
    ...
    // Agrupar por medidas dentro del diseño.
    final byMedida =
...
/// Una variante = una medida específica de un diseño, con sus claves,
/// precios, dimensiones de empaque (largop × anchop × altop, m) y peso (kg),
/// más el desglose de inventario.
class Variante {
