...
class ListaProductosVenta extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // (todo volvía a cantidad 1 y a "Precio de Lista", el más caro).

    double precioUnitarioDe(ProductoExpoEntity producto) {
      return UtilsVenta.precioSeleccionadoDe(producto.producto1) == 2
    ...
    // subtotalBase: sin descuentos. subtotalConPartidas: solo descuentos por
    // partida (base para convertir un monto general a %). subtotal: final.
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Text(Utils.formatPrice(subtotalBase), style: GoogleFonts.inter(fontSize: 14, fontWeight: FontWeight.bold)),
                  ],
                ),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: Colores.secondaryColor.withOpacity(
                        UtilsVenta.descuentoGeneral > 0 ? 0.14 : 0.06),
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        if (UtilsVenta.hayDescuento)
                          Text(
                            '-${Utils.formatPrice(subtotalBase - subtotal)}',
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      Utils.formatPrice(subtotal + envio),
        ...
        ListView.builder(
          ...
          physics: const NeverScrollableScrollPhysics(),
            ...
            itemBuilder: (context, index) {
              ...
              final currentSelectedPrice = UtilsVenta.precioSeleccionadoDe(clave);

              return HookBuilder(
                // Sin key, al eliminar un producto el TextField del precio
                // manual conservaba el importe del producto anterior.
                key: ValueKey('pv_hooks_$clave'),
                builder: (context) {
                  ...
                  // olvidaba presionar APLICAR y el ticket salía con el precio
                  ...
                  void aplicarPrecio() {
                    ...
                    if (price.round() == (producto.precio2 ?? 0)) return;
                    context.read<ProductosTiendaBloc>().add(UpdateProductEvent(
                        producto.copyWith(precio2: price.round())));
                  }
